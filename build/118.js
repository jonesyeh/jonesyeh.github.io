...
var TableDetailExtSelectModalPage = /** @class */ (function () {
    ...
    TableDetailExtSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-table-detail-ext-select-modal',template:/*ion-inline-start:"F:\ionic4\prod\src\pages\table-detail-ext-select-modal\table-detail-ext-select-modal.html"*/'<!--\n  Generated template for the TableDetailSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>欄位選擇</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <TableDetailExtComponent [show_select]=true [select_item]="select_item" (onSelect)="onSelect($event)" [schemaname]="schemaname"\n    [tablename]="tablename"></TableDetailExtComponent>\n</ion-content>\n'/*ion-inline-end:"F:\ionic4\prod\src\pages\table-detail-ext-select-modal\table-detail-ext-select-modal.html"*/,
        }),
