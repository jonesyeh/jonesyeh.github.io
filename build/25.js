...
var TableSelectModalPage = /** @class */ (function () {
    ...
    TableSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-table-select-modal',template:/*ion-inline-start:"F:\ionic4\prod\src\pages\table-select-modal\table-select-modal.html"*/'<!--\n  Generated template for the TableSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <TableComponent [show_select]=true [select_item]="select_item" (onSelect)="onSelect($event)"></TableComponent>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\ionic4\prod\src\pages\table-select-modal\table-select-modal.html"*/,
        }),
