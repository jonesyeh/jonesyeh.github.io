...
var ProgramSetSelectModalPage = /** @class */ (function () {
    ...
    ProgramSetSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-program-set-select-modal',template:/*ion-inline-start:"F:\ionic4\prod\src\pages\program-set-select-modal\program-set-select-modal.html"*/'<!--\n  Generated template for the ProgramSetSelectModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>執行程式選取</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n    <ProgramSetComponent [show_select]=true (onSelect)="onSelect($event)"  [select_item]="select_item"  ></ProgramSetComponent>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\ionic4\prod\src\pages\program-set-select-modal\program-set-select-modal.html"*/,
        }),
