...
var TableDetailDetailPage = /** @class */ (function () {
    ...
    TableDetailDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-table-detail-detail',template:/*ion-inline-start:"F:\ionic4\prod\src\pages\table-detail-detail\table-detail-detail.html"*/'<ion-header>\n    <headerComponent [title]="\'資料欄位明細\'" [permission_id]="\'CanTable\'"></headerComponent>\n\n  </ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n      <ion-col col-12 col-sm-10 col-md-10>\n\n        <ion-grid *ngIf="item" [ngClass]="[\'bordered\']">\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                編號\n              </div>\n              {{item.column_id}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                欄位名稱\n              </div>\n              {{item.columnname}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                  資料型態\n              </div>\n              <b>{{item.data_type}}</b>\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n                <div [ngClass]="[\'label80\']">\n                  欄位說明\n                </div>\n                {{item.columncname}}\n              </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                  是否主鍵\n              </div>\n              {{item.is_pk}}\n            </ion-col>\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                  空值\n              </div>\n              {{item.is_nullable}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n               預設值\n              </div>\n               {{item.default_value}}\n            </ion-col>\n\n            <ion-col col-12 col-sm-6>\n              <div [ngClass]="[\'label80\']">\n                  計算欄位\n              </div>\n               {{item.computecolumn}}\n            </ion-col>\n          </ion-row>\n          <ion-row>\n\n              <ion-col col-12 col-sm-6>\n                <div [ngClass]="[\'label80\']">\n                    自動累加\n                </div>\n                 {{item.is_identity}}\n              </ion-col>\n\n              <ion-col col-12 col-sm-6>\n                <div [ngClass]="[\'label80\']">\n                    備註說明\n                </div>\n                 {{item.memo}}\n              </ion-col>\n            </ion-row>\n\n        </ion-grid>\n      </ion-col>\n      <ion-col col-12 col-sm-1 col-md-1>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"F:\ionic4\prod\src\pages\table-detail-detail\table-detail-detail.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table_detail_detail__ = __webpack_require__(1652);
