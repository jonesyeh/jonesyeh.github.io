...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__batch_exec_program_select_modal__ = __webpack_require__(1268);
...
var ProgramSetComponent = /** @class */ (function () {
    ...
    ProgramSetComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            outputs: ['onSelect'],template:/*ion-inline-start:"F:\ionic4\prod\src\components\program-set\program-set.html"*/'<!--\n  Generated template for the RolePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n<ion-content (window:resize)="onResize($event)">\n  <ion-row>\n\n    <ion-col>\n\n      <ion-searchbar [ngClass]="[\'search\']" (keyup.enter)="LoadData(true)" placeholder="搜尋關鍵字(執行程式編號、執行程式說明包含)" [(ngModel)]="keyword">\n      </ion-searchbar>\n    </ion-col>\n  </ion-row>\n\n  <ion-grid *ngIf="conf.mobile_mode==false && selectedItem!=null" [ngClass]="\'bordered\'">\n    <ion-row>\n      <ion-col>\n\n        <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(selectedItem)">\n          <ion-icon name="checkmark-circle"></ion-icon>\n        </button>\n\n      </ion-col>\n\n\n    </ion-row>\n  </ion-grid>\n  <ngx-datatable NgxResizeWatcher class="bootstrap" *ngIf="totalRows>0 && conf.mobile_mode==false" [selected]="selected" [selectionType]="\'single\'"\n    (select)=\'onRowSelect($event)\' [rows]="data_list" [columnMode]="\'flex\'" [headerHeight]="40" [rowHeight]="\'auto\'"\n    [footerHeight]="40" [reorderable]=false [limit]="limit" [count]="totalRows" [offset]="offset" (page)=\'setPage($event)\'>\n\n\n    <ngx-datatable-column prop="ssis_program_set_no" name="執行程式編號" [flexGrow]="1">\n    </ngx-datatable-column>\n    <ngx-datatable-column prop="ssis_program_set_desc" name="執行程式說明" [flexGrow]="2">\n    </ngx-datatable-column>\n\n  </ngx-datatable>\n  <div *ngIf="totalRows>0 && conf.mobile_mode==true">\n    <ion-row>\n\n      <ion-col col-lg-4 col-md-6 col-sm-6 col-12 *ngFor="let item of data_list">\n\n        <ion-grid [ngClass]=get_board_class(item)>\n          <ion-row>\n            <ion-col>\n\n              <button small title="加入" *ngIf="show_select==true" ion-button color="danger" icon-left (click)="add(item)">\n                <ion-icon name="checkmark-circle"></ion-icon>\n              </button>\n\n\n            </ion-col>\n          </ion-row>\n\n\n          <ion-row>\n            <ion-col>\n              {{item.ssis_program_set_no}}\n            </ion-col>\n            <ion-col>\n              <div title="執行程式說明" text-right>\n                {{item.ssis_program_set_desc}}\n              </div>\n\n            </ion-col>\n          </ion-row>\n\n\n        </ion-grid>\n      </ion-col>\n\n    </ion-row>\n  </div>\n  <ion-infinite-scroll *ngIf="pageNumber < totalPages && conf.mobile_mode==true" (ionInfinite)="$event.waitFor(doInfinite())">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n    <ion-row>\n      <ion-col>\n        <div [ngClass]="[\'command\']">\n          <button small title="重新整理" ion-button color="dark" icon-left (click)="LoadData(true)">\n            <ion-checkbox name="order_type" title="遞增/遞減" color="dark" [(ngModel)]="order_type" (ionChange)="LoadData(true)"></ion-checkbox>\n            <ion-icon name="refresh"></ion-icon>\n          </button>\n          <button small title="取消" *ngIf="show_select==true" ion-button color="dark" icon-left (click)="close()">\n            <ion-icon name="backspace"></ion-icon>\n          </button>\n\n        </div>\n        <StatusComponent [pageNumber]="pageNumber" [totalPages]="totalPages" [totalRows]="totalRows"></StatusComponent>\n      </ion-col>\n    </ion-row>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"F:\ionic4\prod\src\components\program-set\program-set.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["h" /* LoadingController */],
