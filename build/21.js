...
var CodeSelectModalPage = /** @class */ (function () {
    ...
    CodeSelectModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: "page-code-select-modal",template:/*ion-inline-start:"F:\ionic4\prod\src\pages\code-select-modal\code-select-modal.html"*/'<CodeComponent [title]="\'選取代碼\'" [subject]="\'\'" (onSelect)="onSelect($event)" [code_type]="code_type" [select_key]="select_key"  [code_key]="code_key"  [main_code_type]="main_code_type"  [show_select_add]="show_select_add" [show_select]=true [keyword]="keyword"></CodeComponent>\n'/*ion-inline-end:"F:\ionic4\prod\src\pages\code-select-modal\code-select-modal.html"*/
        }),
